      ...
      >
        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-2">
          ...
          <button
            ...
            disabled={isLoading}
            onClick={onClose}
            className="p-1.5 text-secondary hover:text-primary rounded-lg hover:bg-slate-100 transition-colors disabled:opacity-50 cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex items-center justify-end gap-2.5 px-6 py-4 bg-slate-50/80 border-t border-slate-100">
          <button
            ...
            disabled={isLoading}
            onClick={onClose}
            className="px-4 py-2 text-xs font-semibold text-primary bg-white border border-slate-200 hover:bg-slate-50 rounded-xl transition-colors disabled:opacity-50 cursor-pointer"
          >
            {cancelText}
          </button>
          <button
